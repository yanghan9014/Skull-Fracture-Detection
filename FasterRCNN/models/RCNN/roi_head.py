...
from models.RCNN import _utils as det_utils
from models.RCNN.focal_loss import FocalLoss


def fastrcnn_loss_with_focal_loss(focal_loss, class_logits, box_regression, labels, regression_targets):
    # type: (FocalLoss, Tensor, Tensor, List[Tensor], List[Tensor]) -> Tuple[Tensor, Tensor]
    """
...
class RoIHeads(nn.Module):
    ...
    def forward(
        ...
        if self.training:
            ...
            loss_classifier, loss_box_reg = fastrcnn_loss_with_focal_loss(self.focal_loss, class_logits, box_regression, labels, regression_targets)
